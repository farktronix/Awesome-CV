...
%---------------------------------------------------------
  \cventry
    ...
    \vspace{-2.0mm}
        	\begin{cvitems}
         	\item {Developed software and APIs that shipped in twelve major iOS software releases.}
	...
	\begin{cvsubentries}
		...
		{CloudKit is an API that enables applications to easily access and store custom structured data and large files on the iCloud servers. \newline
